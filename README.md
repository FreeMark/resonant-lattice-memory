...
| Path | What it is |
|---|---|
| `resonant_lattice/` | The plugin (runtime code, `plugin.yaml`, `recommended_config.yaml`, architecture docs, the **206-test** unit suite, the eval harness). |
...
```bash
python resonant_lattice/test_resonant_lattice.py     # expect: 206 passed, 0 failed
```

...
DEFAULT_EXTRACTION_PROMPT = (
    ...
    "- Do NOT store transient point-in-time STATE READINGS as facts: memory/dream "
    "cycle counters, fact/tier/entity/relation COUNTS, before/after tallies, or "
    "health snapshots (e.g. 'X facts, dream_cycle N' or 'count is A before and B "
    "after'). They go stale instantly and are not durable knowledge; if there is a "
    "durable point, it is the design or decision behind the number, not the gauge.\n"
